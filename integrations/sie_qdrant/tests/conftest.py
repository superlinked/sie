"""Qdrant-specific pytest fixtures.

Note: The mock SIEClient and embedding generation logic follows the same
pattern as sie_weaviate/tests/conftest.py and sie_chroma/tests/conftest.py.
If more integrations are added, consider extracting shared fixtures into a
