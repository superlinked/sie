"""Chroma-specific pytest fixtures."""
...
def _create_mock_encode_result(
    ...
    *,
    ...
    Real SDK returns {"dense": np.ndarray, "sparse": {"indices": np.ndarray, "values": np.ndarray}} - numpy arrays directly.
    """
    results = []
...
@pytest.fixture
def research_corpus() -> list[str]:
    """Research corpus for academic use case."""
    return [
        "Attention mechanisms allow models to focus on relevant parts of input.",
        "Transformers revolutionized natural language processing in 2017.",
        "BERT introduced bidirectional training for language understanding.",
        "GPT models use autoregressive training for text generation.",
