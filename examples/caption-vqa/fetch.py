...
Everything lands in evidence/: the twelve images, the pre-registered questions
and patterns, the recorded calls and the run manifest. score.py reads from
...
REVISION = "6d90772866ff2272526f6b386dc2db1bc6837e28"
TASK = "caption-vqa"
