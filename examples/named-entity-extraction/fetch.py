#!/usr/bin/env python3
"""Download the recorded named-entities evidence from a pinned dataset revision.
...
MANIFEST_SHA256 = "21572f3ce107227d755bbbffc3ecc627553d93add4cce5be2a82b943766125d9"
